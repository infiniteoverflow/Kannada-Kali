...
public class Convo2_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        convo2.add(new Convo2(R.drawable.student,R.drawable.teacher,"Nanna hesaru Jacob,Sir !   ","Sari ! Neenu yava class alli oduttiddiya?       ","My name is Jacob,Sir !   ","OK ! Which class do u study? "));
        ...
        convo2.add(new Convo2(R.drawable.student,R.drawable.teacher,"Neevu yaaru Sir?   ","Naanu Kannada adhyaapaka      ","Who are you Sir?   ","I am a Kannada teacher "));
